...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form role="form" action="gradeinsert.action" method="post" id="insertForm">
			...
			<div class="form-group">
				<label for="sub1"> 과목1 : </label>
				<input type="text" class="form-control" id="sub1" name="sub1">
			</div>
			<div class="form-group">
				<label for="sub2"> 과목2 : </label>
				<input type="text" class="form-control" id="sub2" name="sub2">
			</div>
			<div class="form-group">
				<label for="sub3"> 과목3 : </label>
				<input type="text" class="form-control" id="sub3" name="sub3">
			</div>

			<button type="submit" class="btn btn-default btn-sm" id="submitBtn" onclick="location.href='gradelist.action'">추가</button>
			<button type="reset" class="btn btn-default btn-sm btnCancel">취소</button>
			<button type="button" class="btn btn-default btn-sm btnList" onclick="location.href='gradelist.action'">성적 리스트</button>
